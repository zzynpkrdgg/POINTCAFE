...
(function (global, factory) {
  ...
  const ALargeSmall = createLucideIcon("a-large-small", __iconNode$pQ);
  ...
  const AlarmClockCheck = createLucideIcon("alarm-clock-check", __iconNode$pL);
  ...
  const AlarmClockMinus = createLucideIcon("alarm-clock-minus", __iconNode$pK);
  ...
  const AlignVerticalDistributeEnd = createLucideIcon("align-vertical-distribute-end", __iconNode$po);
  ...
  const Ambulance = createLucideIcon("ambulance", __iconNode$pj);
  ...
  const AlignVerticalSpaceBetween = createLucideIcon("align-vertical-space-between", __iconNode$pi);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$p9);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$p8);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$p7);
  ...
  const Apple = createLucideIcon("apple", __iconNode$p6);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$p5);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$p4);
  ...
  const Archive = createLucideIcon("archive", __iconNode$p3);
  ...
  const Armchair = createLucideIcon("armchair", __iconNode$p2);
  ...
  const ArrowBigDown = createLucideIcon("arrow-big-down", __iconNode$p1);
  ...
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$p0);
  ...
  const ArrowBigLeftDash = createLucideIcon("arrow-big-left-dash", __iconNode$o$);
  ...
  const ArrowBigLeft = createLucideIcon("arrow-big-left", __iconNode$o_);
  ...
  const ArrowDownFromLine = createLucideIcon("arrow-down-from-line", __iconNode$oS);
  ...
  const ArrowDownNarrowWide = createLucideIcon("arrow-down-narrow-wide", __iconNode$oR);

  const __iconNode$oQ = [
    ["path", { d: "M17 7 7 17", key: "15tmo1" }],
    ["path", { d: "M17 17H7V7", key: "1org7z" }]
  ];
  const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$oQ);
  ...
  const ArrowUpZA = createLucideIcon("arrow-up-z-a", __iconNode$op);

  const __iconNode$oo = [
    ["path", { d: "m5 12 7-7 7 7", key: "hav0vg" }],
    ["path", { d: "M12 19V5", key: "x0mq9r" }]
  ];
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$oo);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$oa);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$o9);
  ...
  const BadgeEuro = createLucideIcon("badge-euro", __iconNode$o8);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$o7);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$o6);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$o5);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$o4);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$o3);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$o2);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$o1);
  ...
  const BadgeQuestionMark = createLucideIcon("badge-question-mark", __iconNode$o0);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$n$);
  ...
  const BadgeSwissFranc = createLucideIcon("badge-swiss-franc", __iconNode$n_);
  ...
  const BatteryPlus = createLucideIcon("battery-plus", __iconNode$nH);
  ...
  const BatteryMedium = createLucideIcon("battery-medium", __iconNode$nG);
  ...
  const BeanOff = createLucideIcon("bean-off", __iconNode$nD);
  ...
  const Beaker = createLucideIcon("beaker", __iconNode$nC);
  ...
  const BedSingle = createLucideIcon("bed-single", __iconNode$nz);
  ...
  const Bed = createLucideIcon("bed", __iconNode$ny);
  ...
  const Beef = createLucideIcon("beef", __iconNode$nx);
  ...
  const BeerOff = createLucideIcon("beer-off", __iconNode$nw);
  ...
  const Beer = createLucideIcon("beer", __iconNode$nv);
  ...
  const BellDot = createLucideIcon("bell-dot", __iconNode$nu);
  ...
  const BellElectric = createLucideIcon("bell-electric", __iconNode$nt);
  ...
  const BellMinus = createLucideIcon("bell-minus", __iconNode$ns);
  ...
  const BellOff = createLucideIcon("bell-off", __iconNode$nr);
  ...
  const BellPlus = createLucideIcon("bell-plus", __iconNode$nq);
  ...
  const BellRing = createLucideIcon("bell-ring", __iconNode$np);
  ...
  const Bell = createLucideIcon("bell", __iconNode$no);
  ...
  const BetweenHorizontalEnd = createLucideIcon("between-horizontal-end", __iconNode$nn);
  ...
  const BetweenHorizontalStart = createLucideIcon("between-horizontal-start", __iconNode$nm);
  ...
  const BetweenVerticalEnd = createLucideIcon("between-vertical-end", __iconNode$nl);
  ...
  const BicepsFlexed = createLucideIcon("biceps-flexed", __iconNode$nk);
  ...
  const Bike = createLucideIcon("bike", __iconNode$ni);
  ...
  const Binary = createLucideIcon("binary", __iconNode$nh);
  ...
  const Binoculars = createLucideIcon("binoculars", __iconNode$ng);
  ...
  const Biohazard = createLucideIcon("biohazard", __iconNode$nf);
  ...
  const Bird = createLucideIcon("bird", __iconNode$ne);
  ...
  const Birdhouse = createLucideIcon("birdhouse", __iconNode$nd);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$nc);

  const __iconNode$nb = [
    ["circle", { cx: "9", cy: "9", r: "7", key: "p2h5vp" }],
    ["circle", { cx: "15", cy: "15", r: "7", key: "19ennj" }]
  ];
  const Blend = createLucideIcon("blend", __iconNode$nb);
  ...
  const Blinds = createLucideIcon("blinds", __iconNode$na);
  ...
  const Blocks = createLucideIcon("blocks", __iconNode$n9);
  ...
  const BluetoothConnected = createLucideIcon("bluetooth-connected", __iconNode$n8);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$n7);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$n6);

  const __iconNode$n5 = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
  const Bluetooth = createLucideIcon("bluetooth", __iconNode$n5);
  ...
  const Bold = createLucideIcon("bold", __iconNode$n4);
  ...
  const Bolt = createLucideIcon("bolt", __iconNode$n3);
  ...
  const Bomb = createLucideIcon("bomb", __iconNode$n2);
  ...
  const Bone = createLucideIcon("bone", __iconNode$n1);
  ...
  const BookA = createLucideIcon("book-a", __iconNode$n0);
  ...
  const BookAlert = createLucideIcon("book-alert", __iconNode$m$);
  ...
  const BookCheck = createLucideIcon("book-check", __iconNode$m_);
  ...
  const BookDashed = createLucideIcon("book-dashed", __iconNode$mX);
  ...
  const BookDown = createLucideIcon("book-down", __iconNode$mW);
  ...
  const BookHeadphones = createLucideIcon("book-headphones", __iconNode$mV);
  ...
  const BookHeart = createLucideIcon("book-heart", __iconNode$mU);
  ...
  const BookImage = createLucideIcon("book-image", __iconNode$mT);
  ...
  const BookKey = createLucideIcon("book-key", __iconNode$mS);
  ...
  const BookLock = createLucideIcon("book-lock", __iconNode$mR);
  ...
  const BookMarked = createLucideIcon("book-marked", __iconNode$mQ);
  ...
  const BookMinus = createLucideIcon("book-minus", __iconNode$mO);
  ...
  const BookOpenText = createLucideIcon("book-open-text", __iconNode$mN);
  ...
  const BookOpen = createLucideIcon("book-open", __iconNode$mM);
  ...
  const BookPlus = createLucideIcon("book-plus", __iconNode$mL);
  ...
  const BookSearch = createLucideIcon("book-search", __iconNode$mK);
  ...
  const BookText = createLucideIcon("book-text", __iconNode$mJ);
  ...
  const BookType = createLucideIcon("book-type", __iconNode$mI);
  ...
  const BookUp2 = createLucideIcon("book-up-2", __iconNode$mH);
  ...
  const BookUp = createLucideIcon("book-up", __iconNode$mG);
  ...
  const BookUser = createLucideIcon("book-user", __iconNode$mF);
  ...
  const BookX = createLucideIcon("book-x", __iconNode$mE);
  ...
  const Book = createLucideIcon("book", __iconNode$mD);

  const __iconNode$mC = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z", key: "169p4p" }],
    ["path", { d: "m9 10 2 2 4-4", key: "1gnqz4" }]
  ];
  const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$mC);

  const __iconNode$mB = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z", key: "1fy3hk" }],
    ["line", { x1: "15", x2: "9", y1: "10", y2: "10", key: "1gty7f" }]
  ];
  const BookmarkMinus = createLucideIcon("bookmark-minus", __iconNode$mB);
  ...
  const BookmarkPlus = createLucideIcon("bookmark-plus", __iconNode$mA);
  ...
  const BookmarkX = createLucideIcon("bookmark-x", __iconNode$mz);
  ...
  const BoomBox = createLucideIcon("boom-box", __iconNode$mx);
  ...
  const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$mw);
  ...
  const BotOff = createLucideIcon("bot-off", __iconNode$mv);
  ...
  const Bot = createLucideIcon("bot", __iconNode$mu);
  ...
  const BowArrow = createLucideIcon("bow-arrow", __iconNode$ms);
  ...
  const Box = createLucideIcon("box", __iconNode$mr);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$mq);
  ...
  const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$mn);
  ...
  const BrainCog = createLucideIcon("brain-cog", __iconNode$mm);
  ...
  const Brain = createLucideIcon("brain", __iconNode$ml);
  ...
  const BrickWallFire = createLucideIcon("brick-wall-fire", __iconNode$mk);
  ...
  const BrickWallShield = createLucideIcon("brick-wall-shield", __iconNode$mj);
  ...
  const BrickWall = createLucideIcon("brick-wall", __iconNode$mi);
  ...
  const BriefcaseBusiness = createLucideIcon("briefcase-business", __iconNode$mh);
  ...
  const BriefcaseConveyorBelt = createLucideIcon("briefcase-conveyor-belt", __iconNode$mg);

  const __iconNode$mf = [
    ["path", { d: "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16", key: "jecpp" }],
    ["rect", { width: "20", height: "14", x: "2", y: "6", rx: "2", key: "i6l2r4" }]
  ];
  const Briefcase = createLucideIcon("briefcase", __iconNode$mf);
  ...
  const BringToFront = createLucideIcon("bring-to-front", __iconNode$md);
  ...
  const BrushCleaning = createLucideIcon("brush-cleaning", __iconNode$mc);
  ...
  const Brush = createLucideIcon("brush", __iconNode$mb);
  ...
  const Bubbles = createLucideIcon("bubbles", __iconNode$ma);
  ...
  const BugOff = createLucideIcon("bug-off", __iconNode$m9);
  ...
  const BugPlay = createLucideIcon("bug-play", __iconNode$m8);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$m7);
  ...
  const Building = createLucideIcon("building", __iconNode$m6);
  ...
  const Bug = createLucideIcon("bug", __iconNode$m5);
  ...
  const BusFront = createLucideIcon("bus-front", __iconNode$m4);
  ...
  const Bus = createLucideIcon("bus", __iconNode$m3);
  ...
  const CableCar = createLucideIcon("cable-car", __iconNode$m2);
  ...
  const Cable = createLucideIcon("cable", __iconNode$m1);
  ...
  const CakeSlice = createLucideIcon("cake-slice", __iconNode$m0);
  ...
  const Cake = createLucideIcon("cake", __iconNode$l$);
  ...
  const Calculator = createLucideIcon("calculator", __iconNode$l_);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$lZ);
  ...
  const CalendarArrowDown = createLucideIcon("calendar-arrow-down", __iconNode$lY);
  ...
  const CalendarArrowUp = createLucideIcon("calendar-arrow-up", __iconNode$lX);
  ...
  const CalendarCheck2 = createLucideIcon("calendar-check-2", __iconNode$lW);
  ...
  const CalendarCheck = createLucideIcon("calendar-check", __iconNode$lV);
  ...
  const CalendarClock = createLucideIcon("calendar-clock", __iconNode$lU);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$lT);
  ...
  const CalendarDays = createLucideIcon("calendar-days", __iconNode$lS);
  ...
  const CalendarFold = createLucideIcon("calendar-fold", __iconNode$lR);
  ...
  const CalendarHeart = createLucideIcon("calendar-heart", __iconNode$lQ);
  ...
  const CalendarMinus2 = createLucideIcon("calendar-minus-2", __iconNode$lP);
  ...
  const CalendarOff = createLucideIcon("calendar-off", __iconNode$lO);
  ...
  const CalendarPlus2 = createLucideIcon("calendar-plus-2", __iconNode$lM);
  ...
  const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$lL);
  ...
  const CalendarRange = createLucideIcon("calendar-range", __iconNode$lK);
  ...
  const CalendarSearch = createLucideIcon("calendar-search", __iconNode$lJ);
  ...
  const CalendarSync = createLucideIcon("calendar-sync", __iconNode$lI);
  ...
  const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$lH);
  ...
  const CalendarX = createLucideIcon("calendar-x", __iconNode$lG);
  ...
  const Calendar = createLucideIcon("calendar", __iconNode$lF);
  ...
  const Calendars = createLucideIcon("calendars", __iconNode$lE);
  ...
  const Candy = createLucideIcon("candy", __iconNode$lz);
  ...
  const Cannabis = createLucideIcon("cannabis", __iconNode$ly);
  ...
  const CaptionsOff = createLucideIcon("captions-off", __iconNode$lx);

  const __iconNode$lw = [
    ["rect", { width: "18", height: "14", x: "3", y: "5", rx: "2", ry: "2", key: "12ruh7" }],
    ["path", { d: "M7 15h4M15 15h2M7 11h2M13 11h4", key: "1ueiar" }]
  ];
  const Captions = createLucideIcon("captions", __iconNode$lw);
  ...
  const CarFront = createLucideIcon("car-front", __iconNode$lv);
  ...
  const CarTaxiFront = createLucideIcon("car-taxi-front", __iconNode$lu);
  ...
  const Car = createLucideIcon("car", __iconNode$lt);
  ...
  const Caravan = createLucideIcon("caravan", __iconNode$ls);
  ...
  const CardSim = createLucideIcon("card-sim", __iconNode$lr);
  ...
  const Carrot = createLucideIcon("carrot", __iconNode$lq);
  ...
  const CaseLower = createLucideIcon("case-lower", __iconNode$lp);
  ...
  const CaseSensitive = createLucideIcon("case-sensitive", __iconNode$lo);
  ...
  const CaseUpper = createLucideIcon("case-upper", __iconNode$ln);
  ...
  const CassetteTape = createLucideIcon("cassette-tape", __iconNode$lm);
  ...
  const Cast = createLucideIcon("cast", __iconNode$ll);
  ...
  const Castle = createLucideIcon("castle", __iconNode$lk);
  ...
  const Cat = createLucideIcon("cat", __iconNode$lj);
  ...
  const Cctv = createLucideIcon("cctv", __iconNode$li);
  ...
  const ChartArea = createLucideIcon("chart-area", __iconNode$lh);
  ...
  const ChartBarBig = createLucideIcon("chart-bar-big", __iconNode$lg);
  ...
  const ChartBarDecreasing = createLucideIcon("chart-bar-decreasing", __iconNode$lf);
  ...
  const ChartBarStacked = createLucideIcon("chart-bar-stacked", __iconNode$le);
  ...
  const ChartBarIncreasing = createLucideIcon("chart-bar-increasing", __iconNode$ld);
  ...
  const ChartBar = createLucideIcon("chart-bar", __iconNode$lc);
  ...
  const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$lb);
  ...
  const ChartColumnBig = createLucideIcon("chart-column-big", __iconNode$la);
  ...
  const ChartColumnDecreasing = createLucideIcon("chart-column-decreasing", __iconNode$l9);
  ...
  const ChartColumnIncreasing = createLucideIcon("chart-column-increasing", __iconNode$l8);
  ...
  const ChartColumn = createLucideIcon("chart-column", __iconNode$l7);
  ...
  const ChartColumnStacked = createLucideIcon("chart-column-stacked", __iconNode$l6);
  ...
  const ChartGantt = createLucideIcon("chart-gantt", __iconNode$l5);

  const __iconNode$l4 = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }]
  ];
  const ChartLine = createLucideIcon("chart-line", __iconNode$l4);
  ...
  const ChartNetwork = createLucideIcon("chart-network", __iconNode$l3);
  ...
  const ChartNoAxesColumnDecreasing = createLucideIcon("chart-no-axes-column-decreasing", __iconNode$l2);
  ...
  const ChartNoAxesColumnIncreasing = createLucideIcon("chart-no-axes-column-increasing", __iconNode$l1);
  ...
  const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$l0);
  ...
  const ChartNoAxesCombined = createLucideIcon("chart-no-axes-combined", __iconNode$k$);
  ...
  const ChartNoAxesGantt = createLucideIcon("chart-no-axes-gantt", __iconNode$k_);
  ...
  const ChessBishop = createLucideIcon("chess-bishop", __iconNode$kR);
  ...
  const ChessKing = createLucideIcon("chess-king", __iconNode$kQ);
  ...
  const ChessKnight = createLucideIcon("chess-knight", __iconNode$kP);
  ...
  const ChessPawn = createLucideIcon("chess-pawn", __iconNode$kO);
  ...
  const ChessQueen = createLucideIcon("chess-queen", __iconNode$kN);
  ...
  const ChessRook = createLucideIcon("chess-rook", __iconNode$kM);

  const __iconNode$kL = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]];
  const ChevronDown = createLucideIcon("chevron-down", __iconNode$kL);

  const __iconNode$kK = [
    ["path", { d: "m17 18-6-6 6-6", key: "1yerx2" }],
    ["path", { d: "M7 6v12", key: "1p53r6" }]
  ];
  const ChevronFirst = createLucideIcon("chevron-first", __iconNode$kK);

  const __iconNode$kJ = [
    ["path", { d: "m7 18 6-6-6-6", key: "lwmzdw" }],
    ["path", { d: "M17 6v12", key: "1o0aio" }]
  ];
  const ChevronLast = createLucideIcon("chevron-last", __iconNode$kJ);

  const __iconNode$kI = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
  const ChevronLeft = createLucideIcon("chevron-left", __iconNode$kI);

  const __iconNode$kH = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]];
  const ChevronRight = createLucideIcon("chevron-right", __iconNode$kH);
  ...
  const ChevronsDownUp = createLucideIcon("chevrons-down-up", __iconNode$kF);

  const __iconNode$kE = [
    ["path", { d: "m7 6 5 5 5-5", key: "1lc07p" }],
    ["path", { d: "m7 13 5 5 5-5", key: "1d48rs" }]
  ];
  const ChevronsDown = createLucideIcon("chevrons-down", __iconNode$kE);
  ...
  const ChevronsLeftRightEllipsis = createLucideIcon("chevrons-left-right-ellipsis", __iconNode$kD);

  const __iconNode$kC = [
    ["path", { d: "m9 7-5 5 5 5", key: "j5w590" }],
    ["path", { d: "m15 7 5 5-5 5", key: "1bl6da" }]
  ];
  const ChevronsLeftRight = createLucideIcon("chevrons-left-right", __iconNode$kC);

  const __iconNode$kB = [
    ["path", { d: "m11 17-5-5 5-5", key: "13zhaf" }],
    ["path", { d: "m18 17-5-5 5-5", key: "h8a8et" }]
  ];
  const ChevronsLeft = createLucideIcon("chevrons-left", __iconNode$kB);

  const __iconNode$kA = [
    ["path", { d: "m20 17-5-5 5-5", key: "30x0n2" }],
    ["path", { d: "m4 17 5-5-5-5", key: "16spf4" }]
  ];
  const ChevronsRightLeft = createLucideIcon("chevrons-right-left", __iconNode$kA);

  const __iconNode$kz = [
    ["path", { d: "m6 17 5-5-5-5", key: "xnjwq" }],
    ["path", { d: "m13 17 5-5-5-5", key: "17xmmf" }]
  ];
  const ChevronsRight = createLucideIcon("chevrons-right", __iconNode$kz);

  const __iconNode$ky = [
    ["path", { d: "m7 15 5 5 5-5", key: "1hf1tw" }],
    ["path", { d: "m7 9 5-5 5 5", key: "sgt6xg" }]
  ];
  const ChevronsUpDown = createLucideIcon("chevrons-up-down", __iconNode$ky);

  const __iconNode$kx = [
    ["path", { d: "m17 11-5-5-5 5", key: "e8nh98" }],
    ["path", { d: "m17 18-5-5-5 5", key: "2avn1x" }]
  ];
  const ChevronsUp = createLucideIcon("chevrons-up", __iconNode$kx);
  ...
  const Chromium = createLucideIcon("chromium", __iconNode$kw);
  ...
  const Church = createLucideIcon("church", __iconNode$kv);
  ...
  const CigaretteOff = createLucideIcon("cigarette-off", __iconNode$ku);
  ...
  const Cigarette = createLucideIcon("cigarette", __iconNode$kt);
  ...
  const CircleAlert = createLucideIcon("circle-alert", __iconNode$ks);
  ...
  const CircleArrowDown = createLucideIcon("circle-arrow-down", __iconNode$kr);
  ...
  const CircleArrowLeft = createLucideIcon("circle-arrow-left", __iconNode$kq);
  ...
  const CircleArrowOutDownRight = createLucideIcon("circle-arrow-out-down-right", __iconNode$kp);
  ...
  const CircleArrowOutDownLeft = createLucideIcon("circle-arrow-out-down-left", __iconNode$ko);
  ...
  const CircleArrowOutUpLeft = createLucideIcon("circle-arrow-out-up-left", __iconNode$kn);
  ...
  const CircleArrowOutUpRight = createLucideIcon("circle-arrow-out-up-right", __iconNode$km);
  ...
  const CircleArrowRight = createLucideIcon("circle-arrow-right", __iconNode$kl);
  ...
  const CircleArrowUp = createLucideIcon("circle-arrow-up", __iconNode$kk);

  const __iconNode$kj = [
    ["path", { d: "M21.801 10A10 10 0 1 1 17 3.335", key: "yps3ct" }],
    ["path", { d: "m9 11 3 3L22 4", key: "1pflzl" }]
  ];
  const CircleCheckBig = createLucideIcon("circle-check-big", __iconNode$kj);

  const __iconNode$ki = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m9 12 2 2 4-4", key: "dzmm74" }]
  ];
  const CircleCheck = createLucideIcon("circle-check", __iconNode$ki);

  const __iconNode$kh = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m16 10-4 4-4-4", key: "894hmk" }]
  ];
  const CircleChevronDown = createLucideIcon("circle-chevron-down", __iconNode$kh);

  const __iconNode$kg = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const CircleChevronLeft = createLucideIcon("circle-chevron-left", __iconNode$kg);

  const __iconNode$kf = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m10 8 4 4-4 4", key: "1wy4r4" }]
  ];
  const CircleChevronRight = createLucideIcon("circle-chevron-right", __iconNode$kf);

  const __iconNode$ke = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const CircleChevronUp = createLucideIcon("circle-chevron-up", __iconNode$ke);
  ...
  const CircleDashed = createLucideIcon("circle-dashed", __iconNode$kd);
  ...
  const CircleDivide = createLucideIcon("circle-divide", __iconNode$kc);
  ...
  const CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode$kb);
  ...
  const CircleDotDashed = createLucideIcon("circle-dot-dashed", __iconNode$ka);

  const __iconNode$k9 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "1", key: "41hilf" }]
  ];
  const CircleDot = createLucideIcon("circle-dot", __iconNode$k9);
  ...
  const CircleEllipsis = createLucideIcon("circle-ellipsis", __iconNode$k8);
  ...
  const CircleEqual = createLucideIcon("circle-equal", __iconNode$k7);
  ...
  const CircleFadingArrowUp = createLucideIcon("circle-fading-arrow-up", __iconNode$k6);
  ...
  const CircleFadingPlus = createLucideIcon("circle-fading-plus", __iconNode$k5);
  ...
  const CircleGauge = createLucideIcon("circle-gauge", __iconNode$k4);

  const __iconNode$k3 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M8 12h8", key: "1wcyev" }]
  ];
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$k3);
  ...
  const CircleOff = createLucideIcon("circle-off", __iconNode$k2);
  ...
  const CircleParkingOff = createLucideIcon("circle-parking-off", __iconNode$k1);

  const __iconNode$k0 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9 17V7h4a3 3 0 0 1 0 6H9", key: "1dfk2c" }]
  ];
  const CircleParking = createLucideIcon("circle-parking", __iconNode$k0);
  ...
  const CirclePause = createLucideIcon("circle-pause", __iconNode$j$);
  ...
  const CirclePercent = createLucideIcon("circle-percent", __iconNode$j_);
  ...
  const CirclePlay = createLucideIcon("circle-play", __iconNode$jZ);
  ...
  const CirclePlus = createLucideIcon("circle-plus", __iconNode$jY);
  ...
  const CirclePoundSterling = createLucideIcon("circle-pound-sterling", __iconNode$jX);
  ...
  const CirclePower = createLucideIcon("circle-power", __iconNode$jW);
  ...
  const CircleSlash2 = createLucideIcon("circle-slash-2", __iconNode$jU);

  const __iconNode$jT = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["line", { x1: "9", x2: "15", y1: "15", y2: "9", key: "1dfufj" }]
  ];
  const CircleSlash = createLucideIcon("circle-slash", __iconNode$jT);
  ...
  const CircleStar = createLucideIcon("circle-star", __iconNode$jR);
  ...
  const ClipboardType = createLucideIcon("clipboard-type", __iconNode$jz);
  ...
  const ClipboardX = createLucideIcon("clipboard-x", __iconNode$jy);
  ...
  const Clipboard = createLucideIcon("clipboard", __iconNode$jx);

  const __iconNode$jw = [
    ["path", { d: "M12 6v6l2-4", key: "miptyd" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock1 = createLucideIcon("clock-1", __iconNode$jw);

  const __iconNode$jv = [
    ["path", { d: "M12 6v6l-2-4", key: "ns39ag" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock11 = createLucideIcon("clock-11", __iconNode$jv);

  const __iconNode$ju = [
    ["path", { d: "M12 6v6l-4-2", key: "cedpoo" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock10 = createLucideIcon("clock-10", __iconNode$ju);

  const __iconNode$jt = [
    ["path", { d: "M12 6v6", key: "1ipuwl" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock12 = createLucideIcon("clock-12", __iconNode$jt);

  const __iconNode$js = [
    ["path", { d: "M12 6v6l4-2", key: "1r2kuh" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock2 = createLucideIcon("clock-2", __iconNode$js);

  const __iconNode$jr = [
    ["path", { d: "M12 6v6h4", key: "135r8i" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock3 = createLucideIcon("clock-3", __iconNode$jr);

  const __iconNode$jq = [
    ["path", { d: "M12 6v6l4 2", key: "mmk7yg" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock4 = createLucideIcon("clock-4", __iconNode$jq);

  const __iconNode$jp = [
    ["path", { d: "M12 6v10", key: "wf7rdh" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock6 = createLucideIcon("clock-6", __iconNode$jp);

  const __iconNode$jo = [
    ["path", { d: "M12 6v6l2 4", key: "1287s9" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock5 = createLucideIcon("clock-5", __iconNode$jo);

  const __iconNode$jn = [
    ["path", { d: "M12 6v6l-2 4", key: "1095bu" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock7 = createLucideIcon("clock-7", __iconNode$jn);

  const __iconNode$jm = [
    ["path", { d: "M12 6v6l-4 2", key: "imc3wl" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock8 = createLucideIcon("clock-8", __iconNode$jm);

  const __iconNode$jl = [
    ["path", { d: "M12 6v6H8", key: "u39vzm" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock9 = createLucideIcon("clock-9", __iconNode$jl);
  ...
  const ClockAlert = createLucideIcon("clock-alert", __iconNode$jk);
  ...
  const ClockArrowDown = createLucideIcon("clock-arrow-down", __iconNode$jj);
  ...
  const ClockCheck = createLucideIcon("clock-check", __iconNode$ji);
  ...
  const ClockArrowUp = createLucideIcon("clock-arrow-up", __iconNode$jh);
  ...
  const ClockFading = createLucideIcon("clock-fading", __iconNode$jg);
  ...
  const ClockPlus = createLucideIcon("clock-plus", __iconNode$jf);

  const __iconNode$je = [
    ["path", { d: "M12 6v6l4 2", key: "mmk7yg" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock = createLucideIcon("clock", __iconNode$je);
  ...
  const ClosedCaption = createLucideIcon("closed-caption", __iconNode$jd);
  ...
  const CloudAlert = createLucideIcon("cloud-alert", __iconNode$jc);

  const __iconNode$jb = [
    ["path", { d: "m17 15-5.5 5.5L9 18", key: "15q87x" }],
    ["path", { d: "M5 17.743A7 7 0 1 1 15.71 10h1.79a4.5 4.5 0 0 1 1.5 8.742", key: "9ho6ki" }]
  ];
  const CloudCheck = createLucideIcon("cloud-check", __iconNode$jb);
  ...
  const CloudCog = createLucideIcon("cloud-cog", __iconNode$ja);
  ...
  const CloudDownload = createLucideIcon("cloud-download", __iconNode$j9);
  ...
  const CloudDrizzle = createLucideIcon("cloud-drizzle", __iconNode$j8);
  ...
  const CloudFog = createLucideIcon("cloud-fog", __iconNode$j7);
  ...
  const CloudHail = createLucideIcon("cloud-hail", __iconNode$j6);

  const __iconNode$j5 = [
    ["path", { d: "M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973", key: "1cez44" }],
    ["path", { d: "m13 12-3 5h4l-3 5", key: "1t22er" }]
  ];
  const CloudLightning = createLucideIcon("cloud-lightning", __iconNode$j5);
  ...
  const CloudMoonRain = createLucideIcon("cloud-moon-rain", __iconNode$j4);
  ...
  const CloudMoon = createLucideIcon("cloud-moon", __iconNode$j3);
  ...
  const CloudOff = createLucideIcon("cloud-off", __iconNode$j2);
  ...
  const CloudRainWind = createLucideIcon("cloud-rain-wind", __iconNode$j1);
  ...
  const CloudRain = createLucideIcon("cloud-rain", __iconNode$j0);
  ...
  const CloudSnow = createLucideIcon("cloud-snow", __iconNode$i$);
  ...
  const CloudSunRain = createLucideIcon("cloud-sun-rain", __iconNode$i_);
  ...
  const Contact = createLucideIcon("contact", __iconNode$iz);
  ...
  const Container = createLucideIcon("container", __iconNode$iy);

  const __iconNode$ix = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 18a6 6 0 0 0 0-12v12z", key: "j4l70d" }]
  ];
  const Contrast = createLucideIcon("contrast", __iconNode$ix);
  ...
  const Cookie = createLucideIcon("cookie", __iconNode$iw);
  ...
  const CookingPot = createLucideIcon("cooking-pot", __iconNode$iv);
  ...
  const CopyCheck = createLucideIcon("copy-check", __iconNode$iu);
  ...
  const CopyMinus = createLucideIcon("copy-minus", __iconNode$it);
  ...
  const CopyPlus = createLucideIcon("copy-plus", __iconNode$is);
  ...
  const CopySlash = createLucideIcon("copy-slash", __iconNode$ir);
  ...
  const CopyX = createLucideIcon("copy-x", __iconNode$iq);

  const __iconNode$ip = [
    ["rect", { width: "14", height: "14", x: "8", y: "8", rx: "2", ry: "2", key: "17jyea" }],
    ["path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2", key: "zix9uf" }]
  ];
  const Copy = createLucideIcon("copy", __iconNode$ip);

  const __iconNode$io = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9.17 14.83a4 4 0 1 0 0-5.66", key: "1sveal" }]
  ];
  const Copyleft = createLucideIcon("copyleft", __iconNode$io);

  const __iconNode$in = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M14.83 14.83a4 4 0 1 1 0-5.66", key: "1i56pz" }]
  ];
  const Copyright = createLucideIcon("copyright", __iconNode$in);

  const __iconNode$im = [
    ["path", { d: "M20 4v7a4 4 0 0 1-4 4H4", key: "6o5b7l" }],
    ["path", { d: "m9 10-5 5 5 5", key: "1kshq7" }]
  ];
  const CornerDownLeft = createLucideIcon("corner-down-left", __iconNode$im);

  const __iconNode$il = [
    ["path", { d: "m15 10 5 5-5 5", key: "qqa56n" }],
    ["path", { d: "M4 4v7a4 4 0 0 0 4 4h12", key: "z08zvw" }]
  ];
  const CornerDownRight = createLucideIcon("corner-down-right", __iconNode$il);

  const __iconNode$ik = [
    ["path", { d: "m14 15-5 5-5-5", key: "1eia93" }],
    ["path", { d: "M20 4h-7a4 4 0 0 0-4 4v12", key: "nbpdq2" }]
  ];
  const CornerLeftDown = createLucideIcon("corner-left-down", __iconNode$ik);

  const __iconNode$ij = [
    ["path", { d: "M14 9 9 4 4 9", key: "1af5af" }],
    ["path", { d: "M20 20h-7a4 4 0 0 1-4-4V4", key: "1blwi3" }]
  ];
  const CornerLeftUp = createLucideIcon("corner-left-up", __iconNode$ij);

  const __iconNode$ii = [
    ["path", { d: "m10 15 5 5 5-5", key: "1hpjnr" }],
    ["path", { d: "M4 4h7a4 4 0 0 1 4 4v12", key: "wcbgct" }]
  ];
  const CornerRightDown = createLucideIcon("corner-right-down", __iconNode$ii);

  const __iconNode$ih = [
    ["path", { d: "m10 9 5-5 5 5", key: "9ctzwi" }],
    ["path", { d: "M4 20h7a4 4 0 0 0 4-4V4", key: "1plgdj" }]
  ];
  const CornerRightUp = createLucideIcon("corner-right-up", __iconNode$ih);

  const __iconNode$ig = [
    ["path", { d: "M20 20v-7a4 4 0 0 0-4-4H4", key: "1nkjon" }],
    ["path", { d: "M9 14 4 9l5-5", key: "102s5s" }]
  ];
  const CornerUpLeft = createLucideIcon("corner-up-left", __iconNode$ig);

  const __iconNode$if = [
    ["path", { d: "m15 14 5-5-5-5", key: "12vg1m" }],
    ["path", { d: "M4 20v-7a4 4 0 0 1 4-4h12", key: "1lu4f8" }]
  ];
  const CornerUpRight = createLucideIcon("corner-up-right", __iconNode$if);
  ...
  const Cpu = createLucideIcon("cpu", __iconNode$ie);
  ...
  const CreativeCommons = createLucideIcon("creative-commons", __iconNode$id);

  const __iconNode$ic = [
    ["rect", { width: "20", height: "14", x: "2", y: "5", rx: "2", key: "ynyp8z" }],
    ["line", { x1: "2", x2: "22", y1: "10", y2: "10", key: "1b3vmo" }]
  ];
  const CreditCard = createLucideIcon("credit-card", __iconNode$ic);
  ...
  const Croissant = createLucideIcon("croissant", __iconNode$ib);

  const __iconNode$ia = [
    ["path", { d: "M6 2v14a2 2 0 0 0 2 2h14", key: "ron5a4" }],
    ["path", { d: "M18 22V8a2 2 0 0 0-2-2H2", key: "7s9ehn" }]
  ];
  const Crop = createLucideIcon("crop", __iconNode$ia);
  ...
  const Cross = createLucideIcon("cross", __iconNode$i9);
  ...
  const Crosshair = createLucideIcon("crosshair", __iconNode$i8);
  ...
  const Crown = createLucideIcon("crown", __iconNode$i7);
  ...
  const Cuboid = createLucideIcon("cuboid", __iconNode$i6);
  ...
  const CupSoda = createLucideIcon("cup-soda", __iconNode$i5);
  ...
  const Currency = createLucideIcon("currency", __iconNode$i4);

  const __iconNode$i3 = [
    ["ellipse", { cx: "12", cy: "5", rx: "9", ry: "3", key: "msslwz" }],
    ["path", { d: "M3 5v14a9 3 0 0 0 18 0V5", key: "aqi0yr" }]
  ];
  const Cylinder = createLucideIcon("cylinder", __iconNode$i3);
  ...
  const Dam = createLucideIcon("dam", __iconNode$i2);
  ...
  const DatabaseBackup = createLucideIcon("database-backup", __iconNode$i1);
  ...
  const DatabaseZap = createLucideIcon("database-zap", __iconNode$i0);
  ...
  const DecimalsArrowLeft = createLucideIcon("decimals-arrow-left", __iconNode$h_);
  ...
  const Donut = createLucideIcon("donut", __iconNode$hz);
  ...
  const DoorClosedLocked = createLucideIcon("door-closed-locked", __iconNode$hy);
  ...
  const DoorOpen = createLucideIcon("door-open", __iconNode$hw);

  const __iconNode$hv = [["circle", { cx: "12.1", cy: "12.1", r: "1", key: "18d7e5" }]];
  const Dot = createLucideIcon("dot", __iconNode$hv);
  ...
  const Download = createLucideIcon("download", __iconNode$hu);
  ...
  const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$hs);
  ...
  const Dribbble = createLucideIcon("dribbble", __iconNode$hr);
  ...
  const Drill = createLucideIcon("drill", __iconNode$hq);
  ...
  const Drone = createLucideIcon("drone", __iconNode$hp);
  ...
  const DropletOff = createLucideIcon("droplet-off", __iconNode$ho);
  ...
  const Droplet = createLucideIcon("droplet", __iconNode$hn);
  ...
  const Droplets = createLucideIcon("droplets", __iconNode$hm);
  ...
  const Drum = createLucideIcon("drum", __iconNode$hj);
  ...
  const EarOff = createLucideIcon("ear-off", __iconNode$hi);

  const __iconNode$hh = [
    ["path", { d: "M6 8.5a6.5 6.5 0 1 1 13 0c0 6-6 6-6 10a3.5 3.5 0 1 1-7 0", key: "1dfaln" }],
    ["path", { d: "M15 8.5a2.5 2.5 0 0 0-5 0v1a2 2 0 1 1 0 4", key: "1qnva7" }]
  ];
  const Ear = createLucideIcon("ear", __iconNode$hh);
  ...
  const EarthLock = createLucideIcon("earth-lock", __iconNode$hg);
  ...
  const Earth = createLucideIcon("earth", __iconNode$hf);

  const __iconNode$he = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 2a7 7 0 1 0 10 10", key: "1yuj32" }]
  ];
  const Eclipse = createLucideIcon("eclipse", __iconNode$he);
  ...
  const EggFried = createLucideIcon("egg-fried", __iconNode$hd);
  ...
  const EggOff = createLucideIcon("egg-off", __iconNode$hc);

  const __iconNode$hb = [
    ["path", { d: "M12 2C8 2 4 8 4 14a8 8 0 0 0 16 0c0-6-4-12-8-12", key: "1le142" }]
  ];
  const Egg = createLucideIcon("egg", __iconNode$hb);
  ...
  const EllipsisVertical = createLucideIcon("ellipsis-vertical", __iconNode$ha);
  ...
  const Ellipsis = createLucideIcon("ellipsis", __iconNode$h9);

  const __iconNode$h8 = [
    ["path", { d: "M5 15a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "yrdkhy" }],
    ["path", { d: "M5 9a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "gzkvyz" }]
  ];
  const EqualApproximately = createLucideIcon("equal-approximately", __iconNode$h8);
  ...
  const EqualNot = createLucideIcon("equal-not", __iconNode$h7);

  const __iconNode$h6 = [
    ["line", { x1: "5", x2: "19", y1: "9", y2: "9", key: "1nwqeh" }],
    ["line", { x1: "5", x2: "19", y1: "15", y2: "15", key: "g8yjpy" }]
  ];
  const Equal = createLucideIcon("equal", __iconNode$h6);
  ...
  const Eraser = createLucideIcon("eraser", __iconNode$h5);
  ...
  const EthernetPort = createLucideIcon("ethernet-port", __iconNode$h4);
  ...
  const Euro = createLucideIcon("euro", __iconNode$h3);
  ...
  const EvCharger = createLucideIcon("ev-charger", __iconNode$h2);
  ...
  const Expand = createLucideIcon("expand", __iconNode$h1);
  ...
  const ExternalLink = createLucideIcon("external-link", __iconNode$h0);
  ...
  const EyeClosed = createLucideIcon("eye-closed", __iconNode$g$);
  ...
  const EyeOff = createLucideIcon("eye-off", __iconNode$g_);
  ...
  const FastForward = createLucideIcon("fast-forward", __iconNode$gU);
  ...
  const FileBraces = createLucideIcon("file-braces", __iconNode$gL);
  ...
  const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$gG);
  ...
  const FileCodeCorner = createLucideIcon("file-code-corner", __iconNode$gD);
  ...
  const FileDigit = createLucideIcon("file-digit", __iconNode$gz);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$gy);
  ...
  const FileExclamationPoint = createLucideIcon("file-exclamation-point", __iconNode$gx);
  ...
  const FileHeadphone = createLucideIcon("file-headphone", __iconNode$gw);
  ...
  const FileHeart = createLucideIcon("file-heart", __iconNode$gv);
  ...
  const FileInput = createLucideIcon("file-input", __iconNode$gt);
  ...
  const FileKey = createLucideIcon("file-key", __iconNode$gs);
  ...
  const FileLock = createLucideIcon("file-lock", __iconNode$gr);
  ...
  const FileMinusCorner = createLucideIcon("file-minus-corner", __iconNode$gq);
  ...
  const FileMinus = createLucideIcon("file-minus", __iconNode$gp);
  ...
  const FileMusic = createLucideIcon("file-music", __iconNode$go);
  ...
  const FileOutput = createLucideIcon("file-output", __iconNode$gn);
  ...
  const FilePenLine = createLucideIcon("file-pen-line", __iconNode$gm);
  ...
  const FilePen = createLucideIcon("file-pen", __iconNode$gl);
  ...
  const FilePlay = createLucideIcon("file-play", __iconNode$gk);
  ...
  const FilePlusCorner = createLucideIcon("file-plus-corner", __iconNode$gj);
  ...
  const FilePlus = createLucideIcon("file-plus", __iconNode$gi);
  ...
  const FileQuestionMark = createLucideIcon("file-question-mark", __iconNode$gh);
  ...
  const FileScan = createLucideIcon("file-scan", __iconNode$gg);
  ...
  const FileSearchCorner = createLucideIcon("file-search-corner", __iconNode$gf);
  ...
  const FileSearch = createLucideIcon("file-search", __iconNode$ge);
  ...
  const FileSignal = createLucideIcon("file-signal", __iconNode$gd);
  ...
  const FileSliders = createLucideIcon("file-sliders", __iconNode$gc);
  ...
  const FileSpreadsheet = createLucideIcon("file-spreadsheet", __iconNode$g9);
  ...
  const FileTerminal = createLucideIcon("file-terminal", __iconNode$g8);
  ...
  const FileText = createLucideIcon("file-text", __iconNode$g7);
  ...
  const FileTypeCorner = createLucideIcon("file-type-corner", __iconNode$g6);
  ...
  const FileType = createLucideIcon("file-type", __iconNode$g5);
  ...
  const FileUp = createLucideIcon("file-up", __iconNode$g4);
  ...
  const FileUser = createLucideIcon("file-user", __iconNode$g3);
  ...
  const FileVideoCamera = createLucideIcon("file-video-camera", __iconNode$g2);
  ...
  const FileVolume = createLucideIcon("file-volume", __iconNode$g1);
  ...
  const FileXCorner = createLucideIcon("file-x-corner", __iconNode$g0);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$f$);
  ...
  const File = createLucideIcon("file", __iconNode$f_);
  ...
  const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$fY);
  ...
  const FoldVertical = createLucideIcon("fold-vertical", __iconNode$fz);
  ...
  const FolderArchive = createLucideIcon("folder-archive", __iconNode$fy);
  ...
  const FolderCheck = createLucideIcon("folder-check", __iconNode$fx);
  ...
  const FolderClosed = createLucideIcon("folder-closed", __iconNode$fw);
  ...
  const FolderClock = createLucideIcon("folder-clock", __iconNode$fv);
  ...
  const FolderCode = createLucideIcon("folder-code", __iconNode$fu);
  ...
  const FolderCog = createLucideIcon("folder-cog", __iconNode$ft);
  ...
  const FolderDot = createLucideIcon("folder-dot", __iconNode$fs);
  ...
  const FolderDown = createLucideIcon("folder-down", __iconNode$fr);
  ...
  const FolderGit2 = createLucideIcon("folder-git-2", __iconNode$fq);
  ...
  const FolderGit = createLucideIcon("folder-git", __iconNode$fp);
  ...
  const FolderHeart = createLucideIcon("folder-heart", __iconNode$fo);
  ...
  const FolderInput = createLucideIcon("folder-input", __iconNode$fn);
  ...
  const FolderKanban = createLucideIcon("folder-kanban", __iconNode$fm);
  ...
  const FolderKey = createLucideIcon("folder-key", __iconNode$fl);
  ...
  const FolderLock = createLucideIcon("folder-lock", __iconNode$fk);
  ...
  const FolderMinus = createLucideIcon("folder-minus", __iconNode$fj);
  ...
  const FolderOpenDot = createLucideIcon("folder-open-dot", __iconNode$fi);
  ...
  const FolderOpen = createLucideIcon("folder-open", __iconNode$fh);
  ...
  const FolderOutput = createLucideIcon("folder-output", __iconNode$fg);
  ...
  const FolderPen = createLucideIcon("folder-pen", __iconNode$ff);
  ...
  const FolderPlus = createLucideIcon("folder-plus", __iconNode$fe);
  ...
  const FolderRoot = createLucideIcon("folder-root", __iconNode$fd);
  ...
  const FolderSearch2 = createLucideIcon("folder-search-2", __iconNode$fc);
  ...
  const FolderSearch = createLucideIcon("folder-search", __iconNode$fb);
  ...
  const FolderSymlink = createLucideIcon("folder-symlink", __iconNode$fa);
  ...
  const FolderSync = createLucideIcon("folder-sync", __iconNode$f9);
  ...
  const FolderTree = createLucideIcon("folder-tree", __iconNode$f8);
  ...
  const FolderUp = createLucideIcon("folder-up", __iconNode$f7);
  ...
  const FolderX = createLucideIcon("folder-x", __iconNode$f6);
  ...
  const Folder = createLucideIcon("folder", __iconNode$f5);
  ...
  const Folders = createLucideIcon("folders", __iconNode$f4);
  ...
  const Footprints = createLucideIcon("footprints", __iconNode$f3);
  ...
  const Forklift = createLucideIcon("forklift", __iconNode$f2);
  ...
  const Form = createLucideIcon("form", __iconNode$f1);

  const __iconNode$f0 = [
    ["path", { d: "m15 17 5-5-5-5", key: "nf172w" }],
    ["path", { d: "M4 18v-2a4 4 0 0 1 4-4h12", key: "jmiej9" }]
  ];
  const Forward = createLucideIcon("forward", __iconNode$f0);
  ...
  const Frame = createLucideIcon("frame", __iconNode$e$);

  const __iconNode$e_ = [
    ["path", { d: "M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7", key: "1a2nng" }]
  ];
  const Framer = createLucideIcon("framer", __iconNode$e_);
  ...
  const GitBranchMinus = createLucideIcon("git-branch-minus", __iconNode$eG);
  ...
  const GitCompare = createLucideIcon("git-compare", __iconNode$ez);
  ...
  const GitGraph = createLucideIcon("git-graph", __iconNode$ey);
  ...
  const GitFork = createLucideIcon("git-fork", __iconNode$ex);
  ...
  const GitPullRequestArrow = createLucideIcon("git-pull-request-arrow", __iconNode$ew);
  ...
  const GitMerge = createLucideIcon("git-merge", __iconNode$ev);
  ...
  const GitPullRequestClosed = createLucideIcon("git-pull-request-closed", __iconNode$eu);
  ...
  const GitPullRequestCreate = createLucideIcon("git-pull-request-create", __iconNode$et);
  ...
  const GitPullRequestCreateArrow = createLucideIcon("git-pull-request-create-arrow", __iconNode$es);
  ...
  const GitPullRequestDraft = createLucideIcon("git-pull-request-draft", __iconNode$er);
  ...
  const GitPullRequest = createLucideIcon("git-pull-request", __iconNode$eq);
  ...
  const Github = createLucideIcon("github", __iconNode$ep);
  ...
  const Gitlab = createLucideIcon("gitlab", __iconNode$eo);
  ...
  const GlassWater = createLucideIcon("glass-water", __iconNode$en);
  ...
  const Glasses = createLucideIcon("glasses", __iconNode$em);
  ...
  const GlobeLock = createLucideIcon("globe-lock", __iconNode$el);
  ...
  const Globe = createLucideIcon("globe", __iconNode$ek);
  ...
  const Goal = createLucideIcon("goal", __iconNode$ej);
  ...
  const Gpu = createLucideIcon("gpu", __iconNode$ei);
  ...
  const GraduationCap = createLucideIcon("graduation-cap", __iconNode$eh);
  ...
  const Grape = createLucideIcon("grape", __iconNode$eg);
  ...
  const Grid2x2Check = createLucideIcon("grid-2x2-check", __iconNode$ef);
  ...
  const Grid2x2Plus = createLucideIcon("grid-2x2-plus", __iconNode$ee);
  ...
  const Grid2x2X = createLucideIcon("grid-2x2-x", __iconNode$ed);
  ...
  const Grid2x2 = createLucideIcon("grid-2x2", __iconNode$ec);
  ...
  const Grid3x2 = createLucideIcon("grid-3x2", __iconNode$eb);
  ...
  const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$ea);
  ...
  const GripHorizontal = createLucideIcon("grip-horizontal", __iconNode$e9);
  ...
  const GripVertical = createLucideIcon("grip-vertical", __iconNode$e8);
  ...
  const Grip = createLucideIcon("grip", __iconNode$e7);
  ...
  const Group = createLucideIcon("group", __iconNode$e6);
  ...
  const Ham = createLucideIcon("ham", __iconNode$e5);
  ...
  const Guitar = createLucideIcon("guitar", __iconNode$e4);
  ...
  const Hamburger = createLucideIcon("hamburger", __iconNode$e3);
  ...
  const Hammer = createLucideIcon("hammer", __iconNode$e2);
  ...
  const HandCoins = createLucideIcon("hand-coins", __iconNode$e1);
  ...
  const HandFist = createLucideIcon("hand-fist", __iconNode$e0);
  ...
  const HandGrab = createLucideIcon("hand-grab", __iconNode$d$);
  ...
  const HandHeart = createLucideIcon("hand-heart", __iconNode$d_);
  ...
  const HandPlatter = createLucideIcon("hand-platter", __iconNode$dX);
  ...
  const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$dA);
  ...
  const HeartMinus = createLucideIcon("heart-minus", __iconNode$dz);
  ...
  const HeartOff = createLucideIcon("heart-off", __iconNode$dy);
  ...
  const HeartPlus = createLucideIcon("heart-plus", __iconNode$dx);
  ...
  const HeartPulse = createLucideIcon("heart-pulse", __iconNode$dw);
  ...
  const Heart = createLucideIcon("heart", __iconNode$dv);
  ...
  const Heater = createLucideIcon("heater", __iconNode$du);
  ...
  const Helicopter = createLucideIcon("helicopter", __iconNode$dt);
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$ds);

  const __iconNode$dr = [
    ["path", { d: "m9 11-6 6v3h9l3-3", key: "1a3l36" }],
    ["path", { d: "m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4", key: "14a9rk" }]
  ];
  const Highlighter = createLucideIcon("highlighter", __iconNode$dr);
  ...
  const History = createLucideIcon("history", __iconNode$dq);
  ...
  const HopOff = createLucideIcon("hop-off", __iconNode$dp);
  ...
  const Hop = createLucideIcon("hop", __iconNode$do);
  ...
  const Hospital = createLucideIcon("hospital", __iconNode$dn);
  ...
  const Hotel = createLucideIcon("hotel", __iconNode$dm);
  ...
  const Hourglass = createLucideIcon("hourglass", __iconNode$dl);
  ...
  const HouseHeart = createLucideIcon("house-heart", __iconNode$dk);
  ...
  const HousePlug = createLucideIcon("house-plug", __iconNode$dj);
  ...
  const HousePlus = createLucideIcon("house-plus", __iconNode$di);
  ...
  const HouseWifi = createLucideIcon("house-wifi", __iconNode$dh);
  ...
  const House = createLucideIcon("house", __iconNode$dg);
  ...
  const IceCreamBowl = createLucideIcon("ice-cream-bowl", __iconNode$df);
  ...
  const IceCreamCone = createLucideIcon("ice-cream-cone", __iconNode$de);
  ...
  const IdCardLanyard = createLucideIcon("id-card-lanyard", __iconNode$dd);
  ...
  const IdCard = createLucideIcon("id-card", __iconNode$dc);
  ...
  const ImageDown = createLucideIcon("image-down", __iconNode$db);
  ...
  const ImageMinus = createLucideIcon("image-minus", __iconNode$da);
  ...
  const ImageOff = createLucideIcon("image-off", __iconNode$d9);
  ...
  const ImagePlay = createLucideIcon("image-play", __iconNode$d8);
  ...
  const ImagePlus = createLucideIcon("image-plus", __iconNode$d7);
  ...
  const ImageUp = createLucideIcon("image-up", __iconNode$d6);
  ...
  const ImageUpscale = createLucideIcon("image-upscale", __iconNode$d5);
  ...
  const Image = createLucideIcon("image", __iconNode$d4);
  ...
  const Images = createLucideIcon("images", __iconNode$d3);
  ...
  const Import = createLucideIcon("import", __iconNode$d2);
  ...
  const Inbox = createLucideIcon("inbox", __iconNode$d1);
  ...
  const IndianRupee = createLucideIcon("indian-rupee", __iconNode$d0);
  ...
  const Infinity = createLucideIcon("infinity", __iconNode$c_);
  ...
  const Kayak = createLucideIcon("kayak", __iconNode$cS);
  ...
  const Kanban = createLucideIcon("kanban", __iconNode$cR);
  ...
  const KeyRound = createLucideIcon("key-round", __iconNode$cQ);
  ...
  const Keyboard = createLucideIcon("keyboard", __iconNode$cL);
  ...
  const LampCeiling = createLucideIcon("lamp-ceiling", __iconNode$cK);
  ...
  const Landmark = createLucideIcon("landmark", __iconNode$cD);
  ...
  const Languages = createLucideIcon("languages", __iconNode$cC);
  ...
  const LaptopMinimalCheck = createLucideIcon("laptop-minimal-check", __iconNode$cB);

  const __iconNode$cA = [
    ["rect", { width: "18", height: "12", x: "3", y: "4", rx: "2", ry: "2", key: "1qhy41" }],
    ["line", { x1: "2", x2: "22", y1: "20", y2: "20", key: "ni3hll" }]
  ];
  const LaptopMinimal = createLucideIcon("laptop-minimal", __iconNode$cA);
  ...
  const Laptop = createLucideIcon("laptop", __iconNode$cz);
  ...
  const LassoSelect = createLucideIcon("lasso-select", __iconNode$cy);
  ...
  const Lasso = createLucideIcon("lasso", __iconNode$cx);
  ...
  const Laugh = createLucideIcon("laugh", __iconNode$cw);
  ...
  const Layers2 = createLucideIcon("layers-2", __iconNode$cv);
  ...
  const Layers = createLucideIcon("layers", __iconNode$cu);
  ...
  const LayoutDashboard = createLucideIcon("layout-dashboard", __iconNode$ct);
  ...
  const LayoutGrid = createLucideIcon("layout-grid", __iconNode$cs);
  ...
  const LayoutList = createLucideIcon("layout-list", __iconNode$cr);
  ...
  const LayoutPanelLeft = createLucideIcon("layout-panel-left", __iconNode$cq);
  ...
  const LayoutPanelTop = createLucideIcon("layout-panel-top", __iconNode$cp);
  ...
  const LayoutTemplate = createLucideIcon("layout-template", __iconNode$co);
  ...
  const Leaf = createLucideIcon("leaf", __iconNode$cn);
  ...
  const LeafyGreen = createLucideIcon("leafy-green", __iconNode$cm);
  ...
  const Lectern = createLucideIcon("lectern", __iconNode$cl);
  ...
  const LibraryBig = createLucideIcon("library-big", __iconNode$ck);
  ...
  const LifeBuoy = createLucideIcon("life-buoy", __iconNode$cg);
  ...
  const Lightbulb = createLucideIcon("lightbulb", __iconNode$cf);
  ...
  const LineSquiggle = createLucideIcon("line-squiggle", __iconNode$ce);
  ...
  const Link2Off = createLucideIcon("link-2-off", __iconNode$cd);
  ...
  const Link2 = createLucideIcon("link-2", __iconNode$cc);

  const __iconNode$cb = [
    ["path", { d: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71", key: "1cjeqo" }],
    ["path", { d: "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71", key: "19qd67" }]
  ];
  const Link = createLucideIcon("link", __iconNode$cb);
  ...
  const Linkedin = createLucideIcon("linkedin", __iconNode$ca);
  ...
  const ListCheck = createLucideIcon("list-check", __iconNode$c9);
  ...
  const ListChecks = createLucideIcon("list-checks", __iconNode$c8);
  ...
  const ListChevronsDownUp = createLucideIcon("list-chevrons-down-up", __iconNode$c7);
  ...
  const ListChevronsUpDown = createLucideIcon("list-chevrons-up-down", __iconNode$c6);
  ...
  const ListCollapse = createLucideIcon("list-collapse", __iconNode$c5);
  ...
  const ListEnd = createLucideIcon("list-end", __iconNode$c4);
  ...
  const ListFilterPlus = createLucideIcon("list-filter-plus", __iconNode$c3);
  ...
  const ListFilter = createLucideIcon("list-filter", __iconNode$c2);
  ...
  const ListIndentDecrease = createLucideIcon("list-indent-decrease", __iconNode$c1);
  ...
  const ListIndentIncrease = createLucideIcon("list-indent-increase", __iconNode$c0);
  ...
  const ListMusic = createLucideIcon("list-music", __iconNode$b_);
  ...
  const LocateOff = createLucideIcon("locate-off", __iconNode$bM);
  ...
  const LockKeyholeOpen = createLucideIcon("lock-keyhole-open", __iconNode$bK);
  ...
  const LockKeyhole = createLucideIcon("lock-keyhole", __iconNode$bJ);

  const __iconNode$bI = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 9.9-1", key: "1mm8w8" }]
  ];
  const LockOpen = createLucideIcon("lock-open", __iconNode$bI);

  const __iconNode$bH = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 10 0v4", key: "fwvmzm" }]
  ];
  const Lock = createLucideIcon("lock", __iconNode$bH);
  ...
  const LogOut = createLucideIcon("log-out", __iconNode$bF);
  ...
  const Logs = createLucideIcon("logs", __iconNode$bE);
  ...
  const Lollipop = createLucideIcon("lollipop", __iconNode$bD);
  ...
  const MailCheck = createLucideIcon("mail-check", __iconNode$bA);
  ...
  const MailMinus = createLucideIcon("mail-minus", __iconNode$by);
  ...
  const MailPlus = createLucideIcon("mail-plus", __iconNode$bx);
  ...
  const MailQuestionMark = createLucideIcon("mail-question-mark", __iconNode$bw);
  ...
  const MailSearch = createLucideIcon("mail-search", __iconNode$bv);
  ...
  const MailWarning = createLucideIcon("mail-warning", __iconNode$bu);
  ...
  const MailX = createLucideIcon("mail-x", __iconNode$bt);

  const __iconNode$bs = [
    ["path", { d: "m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7", key: "132q7q" }],
    ["rect", { x: "2", y: "4", width: "20", height: "16", rx: "2", key: "izxlao" }]
  ];
  const Mail = createLucideIcon("mail", __iconNode$bs);
  ...
  const Mails = createLucideIcon("mails", __iconNode$bq);
  ...
  const MapMinus = createLucideIcon("map-minus", __iconNode$bp);
  ...
  const MapPinCheckInside = createLucideIcon("map-pin-check-inside", __iconNode$bm);
  ...
  const MapPinMinus = createLucideIcon("map-pin-minus", __iconNode$bk);
  ...
  const MapPinOff = createLucideIcon("map-pin-off", __iconNode$bj);
  ...
  const MapPinPen = createLucideIcon("map-pin-pen", __iconNode$bi);
  ...
  const MapPinPlusInside = createLucideIcon("map-pin-plus-inside", __iconNode$bh);
  ...
  const MapPinPlus = createLucideIcon("map-pin-plus", __iconNode$bg);
  ...
  const MapPinXInside = createLucideIcon("map-pin-x-inside", __iconNode$bf);
  ...
  const MapPinX = createLucideIcon("map-pin-x", __iconNode$be);
  ...
  const MapPin = createLucideIcon("map-pin", __iconNode$bd);
  ...
  const MapPinned = createLucideIcon("map-pinned", __iconNode$bc);
  ...
  const MapPlus = createLucideIcon("map-plus", __iconNode$bb);
  ...
  const Map = createLucideIcon("map", __iconNode$b9);
  ...
  const Martini = createLucideIcon("martini", __iconNode$b6);
  ...
  const Maximize = createLucideIcon("maximize", __iconNode$b5);
  ...
  const Medal = createLucideIcon("medal", __iconNode$b4);
  ...
  const MegaphoneOff = createLucideIcon("megaphone-off", __iconNode$b2);
  ...
  const Meh = createLucideIcon("meh", __iconNode$b1);
  ...
  const MemoryStick = createLucideIcon("memory-stick", __iconNode$b0);
  ...
  const Merge = createLucideIcon("merge", __iconNode$a_);
  ...
  const MessagesSquare = createLucideIcon("messages-square", __iconNode$ay);
  ...
  const MonitorX = createLucideIcon("monitor-x", __iconNode$a9);
  ...
  const Monitor = createLucideIcon("monitor", __iconNode$a8);
  ...
  const MoonStar = createLucideIcon("moon-star", __iconNode$a7);
  ...
  const Moon = createLucideIcon("moon", __iconNode$a6);
  ...
  const Motorbike = createLucideIcon("motorbike", __iconNode$a5);
  ...
  const MountainSnow = createLucideIcon("mountain-snow", __iconNode$a2);
  ...
  const MousePointer2Off = createLucideIcon("mouse-pointer-2-off", __iconNode$a1);
  ...
  const MousePointer2 = createLucideIcon("mouse-pointer-2", __iconNode$a0);
  ...
  const MousePointerBan = createLucideIcon("mouse-pointer-ban", __iconNode$9_);
  ...
  const Nut = createLucideIcon("nut", __iconNode$9q);
  ...
  const Octagon = createLucideIcon("octagon", __iconNode$9l);
  ...
  const Omega = createLucideIcon("omega", __iconNode$9k);
  ...
  const Package = createLucideIcon("package", __iconNode$99);
  ...
  const PaintBucket = createLucideIcon("paint-bucket", __iconNode$98);
  ...
  const PaintbrushVertical = createLucideIcon("paintbrush-vertical", __iconNode$96);
  ...
  const Paintbrush = createLucideIcon("paintbrush", __iconNode$95);
  ...
  const Palette = createLucideIcon("palette", __iconNode$94);
  ...
  const Panda = createLucideIcon("panda", __iconNode$93);
  ...
  const PanelBottomClose = createLucideIcon("panel-bottom-close", __iconNode$92);
  ...
  const PanelBottomDashed = createLucideIcon("panel-bottom-dashed", __iconNode$91);
  ...
  const PanelBottom = createLucideIcon("panel-bottom", __iconNode$8$);
  ...
  const PanelLeftClose = createLucideIcon("panel-left-close", __iconNode$8_);
  ...
  const PanelLeftRightDashed = createLucideIcon("panel-left-right-dashed", __iconNode$8X);
  ...
  const PanelTopBottomDashed = createLucideIcon("panel-top-bottom-dashed", __iconNode$8R);
  ...
  const Pill = createLucideIcon("pill", __iconNode$89);
  ...
  const PinOff = createLucideIcon("pin-off", __iconNode$88);
  ...
  const Pin = createLucideIcon("pin", __iconNode$87);
  ...
  const Pipette = createLucideIcon("pipette", __iconNode$86);
  ...
  const Pizza = createLucideIcon("pizza", __iconNode$85);
  ...
  const PlaneLanding = createLucideIcon("plane-landing", __iconNode$84);
  ...
  const PlaneTakeoff = createLucideIcon("plane-takeoff", __iconNode$83);
  ...
  const Plane = createLucideIcon("plane", __iconNode$81);
  ...
  const Plug2 = createLucideIcon("plug-2", __iconNode$80);
  ...
  const PlugZap = createLucideIcon("plug-zap", __iconNode$7$);
  ...
  const Plug = createLucideIcon("plug", __iconNode$7_);
  ...
  const RailSymbol = createLucideIcon("rail-symbol", __iconNode$7x);
  ...
  const Rat = createLucideIcon("rat", __iconNode$7v);
  ...
  const ReceiptCent = createLucideIcon("receipt-cent", __iconNode$7t);
  ...
  const ReceiptEuro = createLucideIcon("receipt-euro", __iconNode$7s);
  ...
  const ReceiptIndianRupee = createLucideIcon("receipt-indian-rupee", __iconNode$7r);
  ...
  const ReceiptRussianRuble = createLucideIcon("receipt-russian-ruble", __iconNode$7o);
  ...
  const RectangleCircle = createLucideIcon("rectangle-circle", __iconNode$7j);
  ...
  const RectangleEllipsis = createLucideIcon("rectangle-ellipsis", __iconNode$7i);
  ...
  const Recycle = createLucideIcon("recycle", __iconNode$7e);

  const __iconNode$7d = [
    ["path", { d: "m15 14 5-5-5-5", key: "12vg1m" }],
    ["path", { d: "M20 9H9.5A5.5 5.5 0 0 0 4 14.5A5.5 5.5 0 0 0 9.5 20H13", key: "6uklza" }]
  ];
  const Redo2 = createLucideIcon("redo-2", __iconNode$7d);
  ...
  const RedoDot = createLucideIcon("redo-dot", __iconNode$7c);

  const __iconNode$7b = [
    ["path", { d: "M21 7v6h-6", key: "3ptur4" }],
    ["path", { d: "M3 17a9 9 0 0 1 9-9 9 9 0 0 1 6 2.3l3 2.7", key: "1kgawr" }]
  ];
  const Redo = createLucideIcon("redo", __iconNode$7b);
  ...
  const RefreshCcw = createLucideIcon("refresh-ccw", __iconNode$79);
  ...
  const RefreshCwOff = createLucideIcon("refresh-cw-off", __iconNode$78);
  ...
  const RefreshCw = createLucideIcon("refresh-cw", __iconNode$77);
  ...
  const Refrigerator = createLucideIcon("refrigerator", __iconNode$76);
  ...
  const RemoveFormatting = createLucideIcon("remove-formatting", __iconNode$74);
  ...
  const Repeat1 = createLucideIcon("repeat-1", __iconNode$73);
  ...
  const Repeat2 = createLucideIcon("repeat-2", __iconNode$72);
  ...
  const Repeat = createLucideIcon("repeat", __iconNode$71);
  ...
  const ReplaceAll = createLucideIcon("replace-all", __iconNode$70);
  ...
  const Replace = createLucideIcon("replace", __iconNode$6$);
  ...
  const ReplyAll = createLucideIcon("reply-all", __iconNode$6_);
  ...
  const RollerCoaster = createLucideIcon("roller-coaster", __iconNode$6T);
  ...
  const Rotate3d = createLucideIcon("rotate-3d", __iconNode$6S);
  ...
  const RotateCcwKey = createLucideIcon("rotate-ccw-key", __iconNode$6R);
  ...
  const RotateCcw = createLucideIcon("rotate-ccw", __iconNode$6P);
  ...
  const RotateCwSquare = createLucideIcon("rotate-cw-square", __iconNode$6O);
  ...
  const Router = createLucideIcon("router", __iconNode$6K);

  const __iconNode$6J = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 12h18", key: "1i2n21" }]
  ];
  const Rows2 = createLucideIcon("rows-2", __iconNode$6J);
  ...
  const Rows3 = createLucideIcon("rows-3", __iconNode$6I);
  ...
  const Rows4 = createLucideIcon("rows-4", __iconNode$6H);
  ...
  const Rss = createLucideIcon("rss", __iconNode$6G);
  ...
  const RulerDimensionLine = createLucideIcon("ruler-dimension-line", __iconNode$6E);
  ...
  const Satellite = createLucideIcon("satellite", __iconNode$6y);
  ...
  const SaudiRiyal = createLucideIcon("saudi-riyal", __iconNode$6x);
  ...
  const Save = createLucideIcon("save", __iconNode$6u);
  ...
  const Scale3d = createLucideIcon("scale-3d", __iconNode$6t);
  ...
  const Scaling = createLucideIcon("scaling", __iconNode$6r);
  ...
  const ScanBarcode = createLucideIcon("scan-barcode", __iconNode$6q);
  ...
  const ScanEye = createLucideIcon("scan-eye", __iconNode$6p);
  ...
  const ScanFace = createLucideIcon("scan-face", __iconNode$6o);
  ...
  const ScanHeart = createLucideIcon("scan-heart", __iconNode$6n);
  ...
  const ScanQrCode = createLucideIcon("scan-qr-code", __iconNode$6l);
  ...
  const ScanSearch = createLucideIcon("scan-search", __iconNode$6k);
  ...
  const Scissors = createLucideIcon("scissors", __iconNode$6f);
  ...
  const Scooter = createLucideIcon("scooter", __iconNode$6e);
  ...
  const ScreenShareOff = createLucideIcon("screen-share-off", __iconNode$6d);
  ...
  const ScreenShare = createLucideIcon("screen-share", __iconNode$6c);
  ...
  const Share2 = createLucideIcon("share-2", __iconNode$5T);
  ...
  const ShowerHead = createLucideIcon("shower-head", __iconNode$5v);
  ...
  const SquareEqual = createLucideIcon("square-equal", __iconNode$4e);
  ...
  const SquarePercent = createLucideIcon("square-percent", __iconNode$42);
  ...
  const Truck = createLucideIcon("truck", __iconNode$1O);
  ...
  const TruckElectric = createLucideIcon("truck-electric", __iconNode$1N);
  ...
  const Undo = createLucideIcon("undo", __iconNode$1y);
  ...
  const UnfoldHorizontal = createLucideIcon("unfold-horizontal", __iconNode$1x);
  ...
  const UndoDot = createLucideIcon("undo-dot", __iconNode$1w);
